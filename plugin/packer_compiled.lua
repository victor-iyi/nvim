...
_G.packer_plugins = {
  ...
  ["cmp-cmdline"] = {
    loaded = true,
    path = "/Users/victor/.local/share/nvim/site/pack/packer/start/cmp-cmdline",
  ...
  ["gitsigns.nvim"] = {
    loaded = true,
    path = "/Users/victor/.local/share/nvim/site/pack/packer/start/gitsigns.nvim",
    url = "https://github.com/lewis6991/gitsigns.nvim"
  },
  ["lspkind.nvim"] = {
    loaded = true,
    path = "/Users/victor/.local/share/nvim/site/pack/packer/start/lspkind.nvim",
    url = "https://github.com/onsails/lspkind.nvim"
  },
  ["lspsaga.nvim"] = {
    loaded = true,
    path = "/Users/victor/.local/share/nvim/site/pack/packer/start/lspsaga.nvim",
    url = "https://github.com/glepnir/lspsaga.nvim"
  },
  ["lualine.nvim"] = {
    loaded = true,
    path = "/Users/victor/.local/share/nvim/site/pack/packer/start/lualine.nvim",
  ...
  ["nvim-ts-autotag"] = {
    ...
    loaded = true,
    needs_bufread = false,
    path = "/Users/victor/.local/share/nvim/site/pack/packer/opt/nvim-ts-autotag",
    url = "https://github.com/windwp/nvim-ts-autotag"
  },
  ["nvim-web-devicons"] = {
    loaded = true,
    path = "/Users/victor/.local/share/nvim/site/pack/packer/start/nvim-web-devicons",
  ...
  undotree = {
    loaded = true,
    path = "/Users/victor/.local/share/nvim/site/pack/packer/start/undotree",
  ...
  ["vim-highlightedyank"] = {
    loaded = true,
    path = "/Users/victor/.local/share/nvim/site/pack/packer/start/vim-highlightedyank",
    url = "https://github.com/machakann/vim-highlightedyank"
  },
  ["vim-matchup"] = {
    loaded = true,
    path = "/Users/victor/.local/share/nvim/site/pack/packer/start/vim-matchup",
    url = "https://github.com/andymass/vim-matchup"
  },
  ["vim-maximizer"] = {
    loaded = true,
    path = "/Users/victor/.local/share/nvim/site/pack/packer/start/vim-maximizer",
    url = "https://github.com/szw/vim-maximizer"
  },
  ["vim-nightfly-guicolors"] = {
    loaded = true,
    path = "/Users/victor/.local/share/nvim/site/pack/packer/start/vim-nightfly-guicolors",
    url = "https://github.com/bluz71/vim-nightfly-guicolors"
  },
  ["vim-python-virtualenv"] = {
    loaded = true,
    path = "/Users/victor/.local/share/nvim/site/pack/packer/start/vim-python-virtualenv",
    url = "https://github.com/sansyrox/vim-python-virtualenv"
  },
  ["vim-rooter"] = {
    loaded = true,
    path = "/Users/victor/.local/share/nvim/site/pack/packer/start/vim-rooter",
